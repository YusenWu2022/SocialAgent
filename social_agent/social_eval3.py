...
def make_inference(input_file_path, output_file_path, model_type, inference_size):
    ...
    if model_type=="llama3":
        ...
        device = "cuda:1"
        model = AutoModelForCausalLM.from_pretrained("AI-ModelScope/Mistral-7B-Instruct-v0.2",torch_dtype=torch.float16,cache_dir="/root/pku/yusen/social_agent/models/mistral")
...
work_dir = "/root/pku/yusen/social_agent/eval/mistral/"
